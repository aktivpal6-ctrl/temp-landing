...
export const MATCH_CRITERIA = [
  ...
  },
  {
    icon: "Gauge",
    title: "Experience",
    body: "Match your level, not someone else's.",
  },
  {
    icon: "MapPin",
    title: "Location",
    body: "People near the places you love.",
  },
  {
    icon: "CalendarClock",
    title: "Availability",
    body: "This weekend, after work or last-minute.",
  },
];
...
export const WHO_FOR = [
  {
    title: "New to Canada",
    body: "You moved here and haven't built your outdoor circle yet.",
  },
  {
    title: "New to the activity",
    body: "You want to start hiking, running or skiing—but going alone feels intimidating.",
  },
  {
    title: "Already active",
    body: "You have the fitness. You just need someone whose schedule and pace match yours.",
  },
  {
    title: "Travelling",
    body: "You want to experience a place with people who actually enjoy doing the same things.",
  },
  {
    title: "Looking for community",
    body: "You want more than likes and followers. You want people you can actually meet.",
  },
];
...
export const SAFETY = [
  ...
  { icon: "IdCard", title: "Profiles", body: "See who you're meeting." },
  {
    ...
    body: "Reputation from real activity.",
  },
  { icon: "Star", title: "Reviews", body: "Trust built over time." },
  {
    icon: "ScrollText",
    title: "Community standards",
    body: "Clear, respectful behaviour.",
  },
];
...
export const SURVEY = [
  ...
  },
  {
    id: "q2",
    type: "single",
    label: "How often do you intentionally do physical or outdoor activities?",
    options: [
      "Almost every day",
      "4–6 times a week",
      "2–3 times a week",
      ...
      "A few times a month",
      "Rarely",
      "I want to be more active but currently don't do much",
    ],
  },
  {
    id: "q3",
    type: "multi",
    label: "What activities are you currently interested in?",
    options: [
      "🥾 Hiking",
  ...
  },
  {
    ...
    type: "single",
    label:
      "Have you ever wanted to do an activity but didn't because you didn't have someone to go with?",
    options: [
      "Yes — frequently",
      "Yes — sometimes",
      "Yes — once or twice",
      "No",
      "I usually prefer doing activities alone",
    ],
  },
  {
    id: "q5",
    type: "multi",
    max: 3,
    label: "What usually stops you from finding someone?",
    hint: "Choose up to 3",
    condition: {
      q: "q4",
      in: ["Yes — frequently", "Yes — sometimes", "Yes — once or twice"],
    },
    options: [
      "My friends aren't interested",
      "My friends aren't available at the same time",
      "We have different fitness levels",
      "We have different skill levels",
      "I don't know enough active people",
      "I recently moved / small social circle",
      "I feel uncomfortable meeting strangers",
      "Safety concerns",
      "I don't know where to find people",
      "Existing FB/WhatsApp/Meetup groups are inconvenient",
      "I don't want to join a large group",
      "I want someone with a similar pace",
      "I want people around my age",
      "I prefer a specific gender",
    ],
    allowOther: true,
  },
  {
    id: "q6",
    type: "multi",
    label: "How do you currently find people to do activities with?",
    options: [
      "Friends / family",
      "Facebook Groups",
      "WhatsApp Groups",
    ...
    followup: {
      ...
      type: "textarea",
      label:
        "What do you like or dislike about the way you currently find people?",
      emphasis: true,
    },
  },
  {
    ...
    type: "scale",
    label:
      "Imagine AKTIVPAL let you post a plan like “Tunnel Bluffs — Sat 8 AM — Beginner/Moderate — 2–3 people, similar pace”, then showed you people interested in the same activity. How useful would that be?",
    low: "Not useful at all",
  ...
  },
  {
    ...
    type: "multi",
    max: 3,
    label: "Which of these would be most valuable to you?",
    hint: "Choose top 3",
    options: [
      "Find people for a specific activity",
      "Match by fitness level",
      "Match by skill level",
      "Match based on pace",
      "Find people available at the same time",
      "Find people nearby",
      "Filter by age",
      "Gender preferences",
      "Identity verification",
      "Ratings / reviews",
      "See someone's activity history",
      "Create / join specific plans",
      "Small groups rather than large events",
      "Meet people new to Canada",
  ...
  },
  {
    ...
    type: "scale",
    section:
      "Trust & Safety — this section is particularly important for AKTIVPAL.",
    label:
      "How comfortable would you be meeting someone you found through AKTIVPAL for an activity?",
  ...
  },
  {
    ...
    options: [
      ...
      "Ability to report / block users",
      "Gender preferences",
      "Small-group activities instead of 1-on-1",
      "Community guidelines",
      "Knowing how long they've been on AKTIVPAL",
    ],
    allowOther: true,
  },
  {
    ...
    type: "scale",
    label:
      "If AKTIVPAL were available today and you found a suitable partner, how likely would you be to actually use it?",
    low: "Definitely wouldn't",
    high: "Definitely would",
  },
  {
    id: "q12",
    type: "single",
    label: "How often could you realistically see yourself using AKTIVPAL?",
    options: [
      ...
      "Once a month",
      "Occasionally",
      "Only for special activities / trips",
    ],
  },
  {
    id: "q13",
    type: "textarea",
    label:
      "What would make you trust AKTIVPAL enough to meet someone from the platform?",
  },
  {
    id: "q14",
    type: "textarea",
    emphasis: true,
    label:
      "What is the ONE thing you wish existed that would make it easier to be active with other people?",
  },
  {
    id: "q15",
    type: "single",
    label:
      "Would you like to be one of the first people to try AKTIVPAL in Canada?",
    options: [
      "Yes — I'd love to",
